...
public class Withdraws extends GridPane{
	...
	public Withdraws() {
		...
		txt = new TextField();
		enter = new Button("Confirm Withdrawl");
		pay = new Button("Pay");
		
		// Buttons
		btnMenu = new Button("Back to Menu");
		btnLogout = new Button("LOGOUT");
		clear =new Button("Cancel");
		newW = new Button("New Withdrawl or Bill Payment");
		...
		this.add(accountChoiceBox,1,2);

		this.add(withdrawLabel, 1, 3);
		this.add(w, 1, 5);
		this.add(pb, 2, 5);
		this.add(billLabel, 3, 6);
		this.add(billChoiceBox, 3, 7);
		this.add(pay, 3, 8);
		this.add(txt,1,7);
		this.add(enter,1,8);
		this.add(btnMenu, 3, 11);
		this.add(btnLogout, 3, 12);
		this.add(clear,1,11);
		this.add(newW,1,12);
	}
