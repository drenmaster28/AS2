...
public CreateAccount (int width, int height) {
		...
		TextField INPUT_fname = new TextField(); 
//		INPUT_fname.setOnAction((event) -> {
//			p.setfName(INPUT_fname.getText());
//		});
		TextField INPUT_lname = new TextField();  
//		INPUT_lname.setOnAction((event) -> {
//			p.setlName(INPUT_lname.getText());
//		});
		TextField INPUT_dob = new TextField(); 
//		INPUT_dob.setOnAction((event) -> {
//			p.setDob(INPUT_dob.getText());
//		});
		TextField INPUT_pwd = new TextField(); 
