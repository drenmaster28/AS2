...
public class Menu extends GridPane {
	...
	public Menu() {
		...
		Text greeting = new Text("Hello " + gName);
		...
		// Format labels
		title.setStyle("-fx-font: normal bolder 20px 'fantasy' ");
		greeting.setStyle("-fx-font: normal bolder 30px 'fantasy' ");
